...
# Lista de dicccionarios
users = [
    {"id": 1, "name": "Gian", "lastname": "Quezada", "curso_fav": "CDyR"},
    {"id": 2, "name": "Magno", "lastname": "Luque", "curso_fav": "Fisica"},
    {"id": 3, "name": "Antony", "lastname": "Mendoza","curso_fav": "Metodos Numericos" },
    {"id": 4, "name": "Edithson", "lastname": "Aybar", "curso_fav": "POO"},
    {"id": 5, "name": "Marlith", "lastname": "llanos", "curso_fav": "Filosofia"}
]
